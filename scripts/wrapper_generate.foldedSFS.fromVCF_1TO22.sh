...
for chrNum in {1..22}
do
variant='/u/project/klohmuel/tanya_data/1000G_Summary_Stats/data/1000G_variants_format/YRI/chr'${chrNum}'_10YRI.GT.FORMAT'
numAllele=20
passCoord='/u/project/klohmuel/tanya_data/1000G_Summary_Stats/data/1000G_masks_position/chr'${chrNum}'_pass_coordinates.txt'
outfile='/u/home/p/phung428/tanya_data_storage/1000G_Summary_Stats/results/foldedSFS/YRI/chr'${chrNum}'_foldedSFS.txt'
