...
numAllele=20
out='/u/home/p/phung428/tanya_data_storage/1000G_Summary_Stats/results/pi_neutral/10kb/YRI/chr'${chrNum}'_10YRI_pi_neutral.txt'
...
for chrNum in {1..22}
do
cat '/u/home/p/phung428/tanya_data_storage/1000G_Summary_Stats/results/pi_neutral/10kb/YRI/chr'${chrNum}'_10YRI_pi_neutral.txt' >> '/u/home/p/phung428/tanya_data_storage/1000G_Summary_Stats/results/pi_neutral/10kb/YRI/autosomes_10YRI_pi_neutral.txt'
done
