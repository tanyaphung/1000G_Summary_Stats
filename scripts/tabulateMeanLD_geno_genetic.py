...
with open("/u/project/klohmuel/tanya_data/1000G_Summary_Stats/results/LD_geno/bins_genetic/YRI/bins_range.txt", "r") as f:
	for line in f:
		line = line.rstrip("\n")
		line = line.split("\t")
...
for i in range(1, 23):
	file = "/u/project/klohmuel/tanya_data/1000G_Summary_Stats/results/LD_geno/bins_genetic/YRI/chr%d_LD_genetic_bins" % i
